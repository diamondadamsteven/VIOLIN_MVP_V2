...
async def PROCESS_WEBSOCKET_FRAME_MESSAGE(MESSAGE_ID: int) -> None:
    ...
    while len(RECORDING_CONFIG_RECORD['AUDIO_BYTES']) >= AUDIO_BYTES_PER_FRAME:
        ...
        SPLIT_100_MS_AUDIO_FRAME_ARRAY[RECORDING_ID][SPLIT_100_MS_AUDIO_FRAME_NO]["AUDIO_ARRAY_16000"] = resample_best(X_441, 44100, 16000)
        ...
        SPLIT_100_MS_AUDIO_FRAME_ARRAY[RECORDING_ID][SPLIT_100_MS_AUDIO_FRAME_NO]["AUDIO_ARRAY_22050"] = resample_best(X_441, 44100, 22050)

...
async def SERVER_ENGINE_AUDIO_STREAM_PROCESS_VOLUME_1_MS(
    ...
    ENGINE_DB_LOG_WEBSOCKET_AUDIO_FRAME_ARRAY[RECORDING_ID][AUDIO_FRAME_NO]["DT_START_VOLUME_1_MS"] = datetime.now()

    # Validate dependencies/data
    if librosa is None:
        CONSOLE_LOG(PREFIX, "LIBROSA_NOT_AVAILABLE", {"rid": RECORDING_ID, "frame": AUDIO_FRAME_NO})
        ENGINE_DB_LOG_WEBSOCKET_AUDIO_FRAME_ARRAY[RECORDING_ID][AUDIO_FRAME_NO]["VOLUME_1_MS_RECORD_CNT"] = 0
        ENGINE_DB_LOG_WEBSOCKET_AUDIO_FRAME_ARRAY[RECORDING_ID][AUDIO_FRAME_NO]["DT_END_VOLUME_1_MS"] = datetime.now()
        return 0
    ...
    # Stamp count
    ENGINE_DB_LOG_WEBSOCKET_AUDIO_FRAME_ARRAY[RECORDING_ID][AUDIO_FRAME_NO]["VOLUME_1_MS_RECORD_CNT"] = len(rows_1ms)
